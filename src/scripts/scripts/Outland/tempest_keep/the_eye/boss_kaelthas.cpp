...
//weapon id + position
static float KaelthasWeapons[7][5] =
{
    {21270, 794.38f, 15, 48.72f +0.5f, 2.9f},                        //[Cosmic Infuser]
    {21269, 785.47f, 12.12f, 48.72f +0.5f, 3.14f},                    //[Devastation]
    {21271, 781.25f, 4.39f, 48.72f +0.5f, 3.14f},                     //[Infinity Blade]
    {21273, 777.38f, -0.81f, 48.72f +0.5f, 3.06f},                    //[Phaseshift Bulwark]
    {21274, 781.48f, -6.08f, 48.72f +0.5f, 3.9f},                     //[Staff of Disintegration]
    {21272, 785.42f, -13.59f, 48.72f +0.5f, 3.4f},                    //[Warp Slicer]
    {21268, 793.06f, -16.61f, 48.72f +0.5f, 3.10f}                    //[Netherstrand Longbow]
};
